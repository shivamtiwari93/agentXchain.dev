...
| `.planning/LAUNCH_BRIEF.md` | **keep-main** | Main has current state with v2.1.0 target and 1033 test count. Release version is stale v2.0.1-era. |
| `.planning/LAUNCH_EVIDENCE_REPORT.md` | **keep-main** | Main has 1033 tests / 235 suites. Post-merge suite run determines final count, update if it changes. |
