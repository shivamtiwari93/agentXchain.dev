# Show HN Draft — AgentXchain v2.155.50

> Draft mirror for `.planning/MARKETING/HN_SUBMISSION.md`. Updated 2026-04-27 for BUG-96 fix: normalize missing decision rationale from existing decision text.
>
> Aggregate evidence:
