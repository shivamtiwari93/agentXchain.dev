# Show HN Draft — AgentXchain v2.155.57

> Draft mirror for `.planning/MARKETING/HN_SUBMISSION.md`. Updated 2026-04-28 for BUG-103 fix: decision titles are normalized into required statements while missing decision text remains fail-closed.
>
> Aggregate evidence:
