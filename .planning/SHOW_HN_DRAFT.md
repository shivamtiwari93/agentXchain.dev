# Show HN Draft — AgentXchain v2.155.62

> Draft mirror for `.planning/MARKETING/HN_SUBMISSION.md`. Updated 2026-04-29 for BUG-108 fix: terminal continuous blockers now stop before post-step recovery can loop.
>
> Aggregate evidence:
