# Show HN Draft — AgentXchain v2.154.5

> Ready-to-post draft for the `v2.154.5` launch window once tester verification lands. Updated 2026-04-22 for the BUG-52 activeCount=0 unblock-loop fix and empty-active evidence-gap proof.
>
> Aggregate evidence:
