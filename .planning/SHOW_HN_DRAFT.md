# Show HN Draft — AgentXchain v2.155.61

> Draft mirror for `.planning/MARKETING/HN_SUBMISSION.md`. Updated 2026-04-29 for BUG-107 fix: Full Auto Mode now recovers paused-but-active continuous sessions while preserving session identity.
>
> Aggregate evidence:
