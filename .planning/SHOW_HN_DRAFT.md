# Show HN Draft — AgentXchain v2.155.56

> Draft mirror for `.planning/MARKETING/HN_SUBMISSION.md`. Updated 2026-04-28 for BUG-102 fix: explicit expected non-zero verification evidence is accepted while undeclared failures remain fail-closed.
>
> Aggregate evidence:
