# Show HN Draft — AgentXchain v2.155.59

> Draft mirror for `.planning/MARKETING/HN_SUBMISSION.md`. Updated 2026-04-28 for BUG-105 fix: strict intent coverage now reads normalized evidence summaries and punctuation-normalized acceptance text.
>
> Aggregate evidence:
