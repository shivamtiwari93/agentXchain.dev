# Show HN Draft — AgentXchain v2.155.58

> Draft mirror for `.planning/MARKETING/HN_SUBMISSION.md`. Updated 2026-04-28 for BUG-104 fix: structured verification observations move into evidence summaries while machine evidence remains strict command proof.
>
> Aggregate evidence:
