# Show HN Draft — AgentXchain v2.155.54

> Draft mirror for `.planning/MARKETING/HN_SUBMISSION.md`. Updated 2026-04-28 for BUG-100 fix: one bounded auto-retry for productive full-auto timeout blockers.
>
> Aggregate evidence:
