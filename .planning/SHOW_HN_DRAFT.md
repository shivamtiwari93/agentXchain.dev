# Show HN Draft — AgentXchain v2.150.0

> Ready-to-post draft for the `v2.150.0` launch window once tester verification lands. Updated 2026-04-21 for the reliability-and-proof release over `v2.149.2` (BUG-54 listener ordering, BUG-55 combined artifact-disposition coverage, benchmark contention flake fix).
>
> Aggregate evidence:
