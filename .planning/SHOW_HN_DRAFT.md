# Show HN Draft — AgentXchain v2.155.51

> Draft mirror for `.planning/MARKETING/HN_SUBMISSION.md`. Updated 2026-04-27 for BUG-97 fix: normalize retained-turn `run_id` drift when `turn_id` matches the active turn.
>
> Aggregate evidence:
