# Show HN Draft — AgentXchain v2.155.52

> Draft mirror for `.planning/MARKETING/HN_SUBMISSION.md`. Updated 2026-04-27 for BUG-98 fix: normalize skip-forward phase-transition requests to the immediate next phase.
>
> Aggregate evidence:
