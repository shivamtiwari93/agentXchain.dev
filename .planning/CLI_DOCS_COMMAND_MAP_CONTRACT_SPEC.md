...
- Governed-adjacent extensions: `template list`, `template validate`, `template set`, `plugin`, `intake`, `multi`, `dashboard`, `doctor`, `history`, `events`, `demo`, `schedule`, `report`, `restore`, `restart`, `escalate`
