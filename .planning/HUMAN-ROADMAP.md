...
Current tester handoff asks: `.planning/TESTER_QUOTEBACK_ASK_V1.md` is the copy-paste BUG-52 third-variant ask; `.planning/TESTER_QUOTEBACK_ASK_V2.md` is the copy-paste BUG-59 / BUG-54 ask; `.planning/TESTER_QUOTEBACK_ASK_V3.md` is the copy-paste BUG-62 reconcile-state ask (self-contained, no companion runbook). These are handoff wrappers around the canonical runbooks and do not replace the literal tester quote-back requirement.
