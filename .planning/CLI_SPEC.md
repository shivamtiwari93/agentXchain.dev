...
- `agentxchain.json` in governed format, including `"template": "<id>"` (defaults to `"generic"`; built-ins currently include `api-service`, `cli-tool`, `library`, `web-app`, `full-local-cli`, and `enterprise-app`)
