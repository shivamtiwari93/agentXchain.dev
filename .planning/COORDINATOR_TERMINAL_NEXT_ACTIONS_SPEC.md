...
- `AT-REPORT-010`: `agentxchain report` on a completed coordinator export keeps `subject.run.next_actions` empty and omits rendered `Next Actions` guidance even when child repos still drift.
