...
- Do not imply live `api_proxy` proposed-authority proof — proposed-authority lifecycle evidence is currently mock-provider E2E only, not real-provider dogfood
