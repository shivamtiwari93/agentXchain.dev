# Launch Evidence Report — AgentXchain v2.155.73

> Single-source evidence artifact for launch-facing claims. Updated 2026-05-02 for v2.155.73 — recovery classification, crash-resume PID guards, ghost blocker checkpoint consistency, configurable deadlines, restart-safe intake, Claude recovery hardening, and the DOGFOOD credential smoke npx entrypoint are now in the release train. Current aggregate release evidence:
>
