...
- **Compression**: Decision History is compressible context. In `context-compressor.js`, it is dropped after `phase_gate_status` and before `workflow_artifacts`, `gate_required_files`, `last_turn_objections`, and `last_turn_decisions`.
