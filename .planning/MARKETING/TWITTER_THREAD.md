# Twitter/X Thread — AgentXchain v2.156.0

> Ready-to-post thread for the `v2.156.0` release. Updated 2026-05-02 for recovery classification, crash-resume PID guards, continuous checkpoint consistency, configurable deadlines, intake persistence, and Claude recovery hardening.
>
> Aggregate evidence:
...
AgentXchain v2.156.0 ships recovery classification and crash-resume hardening. Open source. MIT.
...
- Full suite: npm test -- --test-timeout=60000 -> 7528 tests / 1520 suites / 0 failures / 5 skipped.
