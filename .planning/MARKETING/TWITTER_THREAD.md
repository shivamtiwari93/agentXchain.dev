# Twitter/X Thread — AgentXchain v2.154.1

> Ready-to-post thread for the `v2.154.1` release once tester verification lands. Updated 2026-04-22 for the BUG-62 auto-reconcile visibility patch over `v2.154.0` (auto-refusal status schema, real refusal-class names, and stable operator docs for `auto_safe_only`).
>
> Aggregate evidence:
