# Twitter/X Thread — AgentXchain v2.155.3

> Ready-to-post thread for the `v2.155.3` release once tester verification lands. Updated 2026-04-24 for BUG-62 reconcile-safe-paths allowlist.
>
> Aggregate evidence:
...
AgentXchain v2.155.3 is next in the release lane. Open source. MIT.
