# Twitter/X Thread — AgentXchain v2.154.2

> Ready-to-post thread for the `v2.154.2` release once tester verification lands. Updated 2026-04-22 for the BUG-61 ghost-retry quote-back and diagnostic-surface patch over `v2.154.1` (strict auto-retry preconditions, explicit opt-in docs, and self-contained `attempts_log` stderr/exit fields).
>
> Aggregate evidence:
