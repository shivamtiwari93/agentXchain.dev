# Twitter/X Thread — AgentXchain v2.155.16

> Ready-to-post thread for the `v2.155.16` release once tester verification lands. Updated 2026-04-25 for BUG-72 idle-expansion semantic precheck bypass.
>
> Aggregate evidence:
...
AgentXchain v2.155.16 is next in the release lane. Open source. MIT.
