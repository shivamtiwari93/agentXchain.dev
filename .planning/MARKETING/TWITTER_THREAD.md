# Twitter/X Thread — AgentXchain v2.155.4

> Ready-to-post thread for the `v2.155.4` release once tester verification lands. Updated 2026-04-24 for BUG-64 idle-expansion sidecar acceptance.
>
> Aggregate evidence:
...
AgentXchain v2.155.4 is next in the release lane. Open source. MIT.
