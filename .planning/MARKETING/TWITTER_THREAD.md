# Twitter/X Thread — AgentXchain v2.155.38

> Ready-to-post thread for the `v2.155.38` release. Updated 2026-04-26 for BUG-86 bounded export report verification.
>
> Aggregate evidence:
...
AgentXchain v2.155.38 ships BUG-86 hardening: bounded governance report exports now verify and render when oversized payloads are intentionally truncated or skipped. Open source. MIT.
