# Twitter/X Thread — AgentXchain v2.155.70

> Ready-to-post thread for the `v2.155.70` release. Updated 2026-04-30 for BUG-114 fix: refreshed Claude auth blocker recovery.
>
> Aggregate evidence:
...
AgentXchain v2.155.70 ships BUG-114 fix: full-auto recovery for refreshed Claude auth blockers. Open source. MIT.
...
- Full suite: npm test -- --test-timeout=60000 -> 7333 tests / 1485 suites / 0 failures / 3 skipped.
