# Twitter/X Thread — AgentXchain v2.152.0

> Ready-to-post thread for the `v2.152.0` release once tester verification lands. Updated 2026-04-21 for the architectural-fix release over `v2.150.0` (BUG-59 full-auto gate closure approval_policy ↔ phase-advance coupling, BUG-54 startup watchdog default 30s→120s, BUG-59 template-manifest whitelist repair).
>
> Aggregate evidence:
