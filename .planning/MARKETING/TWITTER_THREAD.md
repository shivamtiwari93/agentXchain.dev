# Twitter/X Thread — AgentXchain v2.155.35

> Ready-to-post thread for the `v2.155.35` release. Updated 2026-04-25 for the BUG-77 roadmap-replenishment ordering.
>
> Aggregate evidence:
...
AgentXchain v2.155.35 ships BUG-77 hardening: exhausted-roadmap projects route PM roadmap-replenishment before generic VISION candidates. Open source. MIT.
