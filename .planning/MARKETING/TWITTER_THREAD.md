# Twitter/X Thread — AgentXchain v2.155.0

> Ready-to-post thread for the `v2.155.0` release once tester verification lands. Updated 2026-04-24 for BUG-60 perpetual continuous idle-expansion policy.
>
> Aggregate evidence:
