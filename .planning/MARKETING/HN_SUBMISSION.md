# Hacker News Submission — AgentXchain v2.155.46

> Ready-to-post for `v2.155.46` launch window. Updated 2026-04-27 for BUG-92 fix: continuous resume reaccepts failed-acceptance staged turns before assigning new work.
>
> Aggregate evidence:
