# Hacker News Submission — AgentXchain v2.121.0

> Ready-to-post. Updated 2026-04-17 for v2.121.0.
...
- `.agentxchain/schedule-state.json` now persists `last_continuous_session_id` truthfully through the normalizer path
...
- 5,478 tests / 1,152 suites / 0 failures, 108 conformance fixtures, Protocol v7 spec for third-party implementors
