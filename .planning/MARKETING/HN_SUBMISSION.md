# Hacker News Submission — AgentXchain v2.155.51

> Ready-to-post for `v2.155.51` launch window. Updated 2026-04-27 for BUG-97 fix: normalize retained-turn `run_id` drift when `turn_id` matches the active turn.
>
> Aggregate evidence:
