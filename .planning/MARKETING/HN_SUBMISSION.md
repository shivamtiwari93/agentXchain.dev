# Hacker News Submission — AgentXchain v2.153.0

> Ready-to-post for the `v2.153.0` launch window once tester verification lands. Updated 2026-04-22 for the BUG-61 ghost-turn auto-recovery release over `v2.152.0` (bounded auto-retry primitive, same-signature early stop, diagnostic bundle, active-run continuation branch).
>
> Aggregate evidence:
