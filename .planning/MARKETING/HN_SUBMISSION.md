# Hacker News Submission — AgentXchain v2.155.8

> Ready-to-post for the `v2.155.8` launch window once tester verification lands. Updated 2026-04-24 for BUG-64 idle-expansion sidecar intent coverage.
>
> Aggregate evidence:
