# Hacker News Submission — AgentXchain v2.155.61

> Ready-to-post for `v2.155.61` launch window. Updated 2026-04-29 for BUG-107 fix: Full Auto Mode now recovers paused-but-active continuous sessions while preserving session identity.
>
> Aggregate evidence:
