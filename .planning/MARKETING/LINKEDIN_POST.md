# LinkedIn Post — AgentXchain v2.155.62

> Ready-to-post LinkedIn company-page copy for the `v2.155.62` release. Updated 2026-04-29 for BUG-108 fix: terminal continuous blockers now stop before post-step recovery can loop.
>
> Aggregate evidence:
...
`v2.155.62` fixes paused-but-active continuous-session recovery in full-auto continuous mode (BUG-107):
