# LinkedIn Post — AgentXchain v2.155.60

> Ready-to-post LinkedIn company-page copy for the `v2.155.60` release. Updated 2026-04-28 for BUG-105 fix: strict intent coverage now reads normalized evidence summaries and punctuation-normalized acceptance text.
>
> Aggregate evidence:
...
`v2.155.60` fixes strict intent coverage over normalized structured verification evidence in full-auto continuous mode (BUG-105):
