# LinkedIn Post — AgentXchain v2.155.61

> Ready-to-post LinkedIn company-page copy for the `v2.155.61` release. Updated 2026-04-29 for BUG-107 fix: Full Auto Mode now recovers paused-but-active continuous sessions while preserving session identity.
>
> Aggregate evidence:
...
`v2.155.61` fixes paused-but-active continuous-session recovery in full-auto continuous mode (BUG-107):
