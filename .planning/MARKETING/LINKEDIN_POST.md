# LinkedIn Post — AgentXchain v2.155.67

> Ready-to-post LinkedIn company-page copy for the `v2.155.67` release. Updated 2026-04-29 for BUG-109 fix: continuous auto-checkpoint recovery for supplemental accepted-turn dirt.
>
> Aggregate evidence:
...
`v2.155.67` fixes paused-but-active continuous-session recovery in full-auto continuous mode (BUG-107):
