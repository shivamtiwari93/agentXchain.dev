# LinkedIn Post — AgentXchain v2.152.0

> Ready-to-post LinkedIn company-page copy for the `v2.152.0` release once tester verification lands. Updated 2026-04-21 for the architectural-fix release over `v2.150.0` (BUG-59 full-auto gate closure coupling, BUG-54 startup watchdog default 30s→120s).
>
> Aggregate evidence:
