...
describe('marketing release post script', () => {
  ...
  it('release script delegates to post-twitter.sh and post-reddit.sh', () => {
...
describe('marketing wrapper scripts', () => {
  it('all three marketing scripts exist and are bash scripts', () => {
    for (const script of [POST_RELEASE, POST_TWITTER, POST_REDDIT]) {
