...
const PROOF_EXAMPLES = ['ci-runner-proof', 'external-runner-starter', 'live-governed-proof', 'checkpoint-handoff-proof', 'live-continuous-3run-proof', 'mcp-echo-agent', 'mcp-http-echo-agent', 'mcp-anthropic-agent', 'remote-agent-bridge', 'remote-conformance-server'];
