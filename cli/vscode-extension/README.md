...
This extension provides governed approval actions, governed step/run launch, governance reports, notifications, and project status inside VS Code.
...
- **Not shipped here:** `restart` or a dashboard replacement inside VS Code.
