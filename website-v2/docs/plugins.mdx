...
Installed plugins: 1
  @agentxchain/plugin-slack-notify@0.1.0
    ...
    Present: yes
    Hooks: after_acceptance: slack_notify_acceptance | before_gate: slack_notify_gate | on_escalation: slack_notify_escalation
```
...
- [Slack notify plugin](/docs/plugins/slack-notify)
- [JSON report plugin](/docs/plugins/json-report)
- [GitHub issues plugin](/docs/plugins/github-issues)
