...
- Replay execution model: AgentXchain runs those declared commands in the local repo shell. Treat `machine_evidence` as trusted agent-authored execution intent, not untrusted user input.
