...
Imports from `agentxchain/runner-interface`. Scaffolds a tiny governed repo, initializes a run, assigns a turn, stages a result by hand, and accepts it. No adapter, no subprocess.
