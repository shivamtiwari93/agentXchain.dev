...
| --- | --- | --- | --- |
| `1` | Core constitutional behavior | `state_machine`, `turn_result_validation`, `gate_semantics`, `decision_ledger`, `history`, `config_schema`, `delegation`, `decision_carryover`, `parallel_turns`, `event_lifecycle` | `71` |
