...
`interface_alignment` is not a heuristic placeholder. The coordinator resolves it by checking accepted decision ledger entries per repo against declared requirements.
