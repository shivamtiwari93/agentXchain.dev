...
If you need CLI usage and exit codes, see the [`verify export` command reference](./cli#verify-export). If you need the constitutional boundary, go back to [Protocol Reference v6](./protocol-reference).
