...
sidebar_position: 4
title: Adapters
description: "Five adapters, one contract. manual, local_cli, api_proxy, mcp, and remote_agent explained."
---
...
- [Quickstart](/docs/quickstart) for the governed bootstrap path
- [CLI Reference](/docs/cli) for the operator command surface
- [Protocol Reference](/docs/protocol) for the turn-result contract and validator rules
- [Build Your Own Connector](/docs/build-your-own-connector) for the implementation checklist that turns this page into a custom runtime

For the canonical reference of all five runtimes, three authority levels, and which combinations are valid, see the [Runtime Matrix](/docs/runtime-matrix).
...
```bash
agentxchain init --governed --dev-command "claude --print --dangerously-skip-permissions" --dev-prompt-transport stdin -y
```
...
If you need the full connector contract, examples, or packaging guidance, continue with [Build Your Own Connector](/docs/build-your-own-connector).
