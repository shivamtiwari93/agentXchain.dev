...
- Runs continuously in GitHub Actions via `.github/workflows/governed-todo-app-proof.yml` on a nightly schedule, release tags, and manual `workflow_dispatch` reruns
