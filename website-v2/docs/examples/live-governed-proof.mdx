...
- Full case study: [Checkpoint Handoff Proof](/docs/examples/checkpoint-handoff-proof)
...
| Evidence artifact | [`checkpoint-handoff-proof.latest.json`](https://github.com/shivamtiwari93/agentxchain.dev/blob/main/examples/live-governed-proof/evidence/checkpoint-handoff-proof.latest.json) |
...
| Session status | `completed` |
| Evidence artifact | [`continuous-mixed-proof.latest.json`](https://github.com/shivamtiwari93/agentxchain.dev/blob/main/examples/live-governed-proof/evidence/continuous-mixed-proof.latest.json) |
...
| CLI version | `2.134.1` |
| Session status | `completed` |
| Evidence artifact | [`continuous-3run-proof.latest.json`](https://github.com/shivamtiwari93/agentxchain.dev/blob/main/examples/live-governed-proof/evidence/continuous-3run-proof.latest.json) |
