...
- [**vs AutoGen**](/docs/compare-autogen) — structured governance vs conversational multi-agent coordination
- [**vs LangGraph**](/docs/compare-langgraph) — protocol-first design vs graph-based agent orchestration
