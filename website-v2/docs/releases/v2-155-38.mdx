...
- BUG-55/87 verification-output evidence should confirm undeclared
  verification outputs are auto-normalized and cleaned up, with
  `verification_output_auto_normalized` event in events.jsonl.
