---
sidebar_position: 0
title: "v2.154.4 Release Notes"
---

# AgentXchain v2.154.4

`v2.154.4` is a BUG-52 third-variant release. It ships the activeCount-agnostic
...
```bash
npx --yes -p agentxchain@2.154.4 -c "agentxchain --version"
```
