---
sidebar_position: 0
title: "v2.154.6 Release Notes"
---

# AgentXchain v2.154.6

`v2.154.6` is the BUG-52 third-variant discriminator repair release. It ships
...
```bash
npx --yes -p agentxchain@2.154.6 -c "agentxchain --version"
```
