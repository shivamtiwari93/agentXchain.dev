...
If you want the end-to-end operator runbook, start with [Lights-Out Operation](/docs/lights-out-operation). This page stays focused on the scheduler contract and config surface.
