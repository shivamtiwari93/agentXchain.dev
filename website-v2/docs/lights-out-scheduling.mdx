...
| `continuous.max_runs` | `100` | Max governed runs before the session exits terminally |
| `continuous.max_idle_cycles` | `3` | Max daemon polls with no derivable work before the `on_idle` policy fires |
