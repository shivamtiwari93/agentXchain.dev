...
**Tip:** `--goal "..."` should be part of the primary scaffold command, not an afterthought. If you skipped it, set `project.goal` in `agentxchain.json` before the first governed turn.
