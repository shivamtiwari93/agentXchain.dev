...
- [tusq.dev dogfood proof](/docs/examples/live-dogfood-tusq-dev-proof): 3 full governed runs on a real production codebase with perpetual idle-expansion, zero reliability failures
