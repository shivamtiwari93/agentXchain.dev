...
| **Timeline** | Repo-local run timeline with continuity status, connector health, active turns with live elapsed time, accepted history with per-turn duration and acceptance timestamp, and expandable turn-level hook evidence |
