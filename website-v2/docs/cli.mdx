...
| `benchmark` | Setup | Run a governed delivery compliance proof in baseline or `--stress` mode — measures admission control, retry handling, gate satisfaction, and export verification |
