...
| **Run History** | Cross-run history showing status, outcome, trigger, context inheritance availability, phases, turns, cost, duration, and retrospective headline for all governed runs in this project from `/api/run-history` |
