...
| View | Description |
|------|-------------|
| **Initiative** | First-glance multi-repo coordinator summary: repo runs, pending gate, blocked state, barrier snapshot, and one primary recovery action; full blocker diagnostics stay in the **Blockers** view sourced from `/api/coordinator/blockers` |
