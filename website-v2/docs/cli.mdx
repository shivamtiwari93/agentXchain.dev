...
`mission attach-chain` defaults to attaching the latest chain report to the latest mission. Use `--mission <mission_id>` when you need to bind a chain to an older or non-latest mission explicitly.
