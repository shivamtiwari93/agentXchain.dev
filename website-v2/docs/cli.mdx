...
| View | Description |
|------|-------------|
| **Initiative** | Multi-repo coordinator summary: repo runs, pending gate, blocked state, barrier snapshot, and coordinator next actions sourced from `/api/coordinator/blockers` |
