...
Before you wire Claude Code into a governed role, read the [Authority Model](/docs/authority-model). `write_authority`, `local_cli`, and Claude's own permission mode are separate axes.
