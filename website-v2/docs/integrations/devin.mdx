...
- **Authority**: Use `"write_authority": "proposed"` so AgentXchain validates Devin's output before applying changes. This keeps governance intact even with an autonomous agent.
