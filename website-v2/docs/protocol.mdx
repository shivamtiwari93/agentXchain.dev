...
| **v7** | 2026-Q2 | Delegation chains with decision contracts. Cross-run decision carryover (`durability: "repo"`). Parallel turns (`max_concurrent_turns`). Run event lifecycle (`events.jsonl`). 102 conformance fixtures across 13 surfaces. |
