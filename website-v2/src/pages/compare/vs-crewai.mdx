...
| **Human review** | Task `human_input`, flow-level `@human_feedback`, approve/reject/revise loops | Phase-transition and run-completion gates |
| **Failure recovery** | Checkpointing and resume for crews, flows, and agents | Blocked-state recovery, `multi resume`, coordinator handoff |
