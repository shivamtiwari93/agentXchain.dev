...
<head>
  ...
  <meta name="description" content="AgentXchain v2.24: all four runtime adapters proven live with real AI models. Mandatory challenge, human sovereignty, real evidence." />
</head>

**April 2026** — AgentXchain v2.24.1 is the first release where every runtime adapter — manual, local CLI, API proxy, and MCP — is proven live with real AI models, not mocks. Escalation, recovery, and the public install path are all exercised through the real CLI.
...
### All 4 adapters live with real models

| Adapter | What it does | Live proof |
|---------|-------------|------------|
| `manual` | Human types the turn result | Proven across multiple governed runs |
| `local_cli` | Claude Code, Cursor, any CLI agent | `run_91f4ba5d54707a7e` — live Claude Code dev turn |
| `api_proxy` | Direct LLM API call with proposal staging | `run_7b067f892916b799` — full proposed-authority lifecycle |
...
# Walk through your first governed turn
# https://agentxchain.dev/docs/first-turn
```
