...
Do NOT modify `agentxchain.json` — this is operator-owned configuration. See `.planning/OPERATOR_OWNED_FILES.md` for the full protected-files list. An architectural decision cannot override this; if a decision implies a config change, route to `human` to apply it.
