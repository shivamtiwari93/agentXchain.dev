...
| BUG-006 | Backend restart crash from migration idempotency | 6 | — | Pending: add integration test for restart on persisted DB | Open |
| BUG-007 | Baby update accepts wrong type payload (`name: 123`) | 6 | — | Pending: API test expecting 400 for wrong types | Open |
